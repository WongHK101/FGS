...
DEFAULT_PACKAGE_ROOT = Path(
    r"G:\ACMMM26\GeometricRepeatability\AssistantPack_DepthReference_MaskNoMask_5scene8method_nativealign_20260508_v1"
)
DEFAULT_FORMAL_ROOT = Path(
    r"G:\ACMMM26\GeometricRepeatability\DepthReference\Formal_5scene_8method_9thr_nativealign_20260508_v1"
)
DEFAULT_MESHFIX_ROOT = Path(r"G:\ACMMM26\GeometricRepeatability\DepthReference\MeshFix_ROICrop_failed3_20260506_v1")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the active native-align depth-reference assistant package.")
    parser.add_argument("--package_root", default=str(DEFAULT_PACKAGE_ROOT))
    parser.add_argument("--formal_root", default=str(DEFAULT_FORMAL_ROOT))
    parser.add_argument("--meshfix_root", default=str(DEFAULT_MESHFIX_ROOT))
