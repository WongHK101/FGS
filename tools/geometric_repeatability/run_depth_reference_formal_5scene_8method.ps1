param(
    ...
    [string]$InventoryCsv = "G:\ACMMM26\GeometricRepeatability\model_inventory_5x8_precheck_v2.csv",
    [string]$GeoRoot = "G:\ACMMM26\GeometricRepeatability",
    [string]$OutRoot = "G:\ACMMM26\GeometricRepeatability\DepthReference\Formal_5scene_8method_9thr_d12trim6_20260505_v1",
